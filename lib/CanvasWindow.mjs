...
export class CanvasWindow extends SimpleEmitter {
  ...
  drawItem (obj, x, y) {
    ...
    this.drawText({ value: obj.count ?? '', stroke: true, fontStyle: 'bold 8px sans-serif', style: 'white' }, x + 7, y + 16)
  }
  ...
  drawText ({ fontStyle = '', style, value, align = undefined, w = undefined, bg, stroke }, x = 0, y = 0) {
    ...
    if (stroke) {
      ...
      this.drawCtx.strokeStyle = stroke
      this.drawCtx.strokeText(value, x, y)
