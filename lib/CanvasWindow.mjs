...
export class CanvasWindow extends SimpleEmitter {
  ...
  drawItem (obj, x, y) {
    ...
    this.drawText({ value: obj.count !== undefined && obj.count !== 1 ? obj.count : '', stroke: true, fontStyle: 'bold 8px sans-serif', style: 'white' }, x + 11, y + 16)
  }
  ...
  drawText ({ fontStyle = '', style, value, align = undefined, w = undefined, bg, stroke }, x = 0, y = 0) {
    ...
    this.drawCtx.font = this.drawCtx.font.replace('sans-serif', 'mojangles,sans-serif')
